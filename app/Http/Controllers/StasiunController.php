...
class StasiunController extends Controller
{
    ...
    {
        $data = Stasiun::where('jenis_perjalanan', 'local')->get();
        $resource = StasiunResource::collection($data);
        return ApiResponse::success('displaying local stasiun data', $resource);
    }

    public function intercity()
    {
        $data = Stasiun::where('jenis_perjalanan', 'intercity')->get();
        $resource = StasiunResource::collection($data);
        return ApiResponse::success('displaying intercity stasiun data', $resource);
    }
